...
class Learner(nn.Module):
    ...
    def __init__(self, args):
        ...
        # torch.save(self.model.state_dict(), 'checkpoints/itd-model.pkl')
    ...
    def forward(self, batch_tasks, training = True, task_batch_id = 0, epoch=0):
        ...
        for task_id, task in enumerate(batch_tasks):
            ...
            q_embedding_fearures = predict(self.meta_model, q_input)
            q_outputs = adapter_model(q_embedding_fearures)
        ...
        if training and self.no_meta==False:
            # outer_optimizer = SGD(self.meta_model.parameters(), lr=self.outer_update_lr)
