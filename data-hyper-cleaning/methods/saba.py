...
class Learner(nn.Module):
    ...
    def __init__(self, args, training_size):
        ...
        self.hyper_gradient = torch.zeros(self.training_size).to(self.device)
    ...
    def forward(self, train_loader, training=True, epoch=0):
        ...
        for step, data in enumerate(train_loader):
            ...
            self.lambda_x.grad = self.hyper_gradient[0]
    ...
    def hypergradient(self, args, jacob_flat, loss, query_batch):
        ...
        self.hyper_gradient = [  Gyxz for  Gyxz in zip(Gyxz_gradient)]
